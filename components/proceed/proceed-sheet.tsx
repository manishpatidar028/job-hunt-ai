...
import { X, FileText, Mail, ExternalLink, Copy, Check, RefreshCw, Sparkles, ChevronRight } from 'lucide-react';
              ...
              {!resume ? (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  <button
                    ...
                    style={primaryBtnStyle(loadingResume)}
                  >
                    {loadingResume
                ...
                <div>
                  <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '8px', marginBottom: '8px' }}>
                    ...
                    <button onClick={generateResume} disabled={loadingResume} style={iconBtnStyle}>
                      {loadingResume ? <><RefreshCw size={12} style={{ animation: 'spin 1s linear infinite' }} /> Regenerating</> : <><RefreshCw size={12} /> Regenerate</>}
                    </button>
                  </div>
                  <pre style={preStyle}>{resume}</pre>
                  {resume && (
                    <button
                      onClick={() => setTab('cover-letter')}
                      style={{ ...primaryBtnStyle(false), marginTop: '12px', width: '100%', justifyContent: 'center' }}
                    >
              ...
              {!coverLetter ? (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  <button
                    ...
                    style={primaryBtnStyle(loadingCover)}
                  >
                    {loadingCover
